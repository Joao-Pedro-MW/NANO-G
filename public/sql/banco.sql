...
commit;
CREATE TABLE IF NOT EXISTS n_itens (
 ...
 CONSTRAINT fk_categoria FOREIGN KEY (id_categoria) REFERENCES n_categorias(id_categoria),
...
CREATE TABLE IF NOT EXISTS n_categorias (
 id_categoria NUMBER(10) NOT NULL,
 categoria_nome VARCHAR2(100),
 CONSTRAINT pk_categoria PRIMARY KEY (id_categoria)
);

CREATE TABLE IF NOT EXISTS n_lotes (
 id_lote NUMBER(10) NOT NULL,
 id_item NUMBER(10) NOT NULL,
 data_validade DATE NOT NULL,
 CONSTRAINT pk_lote PRIMARY KEY (id_lote),
 CONSTRAINT fk_item FOREIGN KEY (id_item) REFERENCES n_itens(id_item)
);